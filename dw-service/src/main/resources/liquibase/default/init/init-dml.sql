...
INSERT INTO `tb_resource` (`id`, `component`, `permission`, `remark`, `sort`, `name`, `type`, `value`, `fk_parent_id`, `icon`, `tenant_id`, `platform_type`, `resource_fk_id`) VALUES ('1061795714310340609', NULL, 'job:list', NULL, '26', '定时任务', '1', '/upms/job-manager', '1', NULL, '0', '2', '-1');
